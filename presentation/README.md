...
# READ HERE #
This code was pulled from origin on 6/23/2013. This flowtime presentation is design to only work with this project.

The presentation is divided up into 3 sections.
1. About the event.
2. Team
3. Our Project
4. Outcome 
...
Core info is from the PPT in the ~/assets dir.
